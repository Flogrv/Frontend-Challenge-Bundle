<template>
    <div v-if="firstUser" class="flex m-auto">
        <div class="flex flex-col sm:flex-row gap-4">
            <div class="relative xs:mr-8 bottom-4 flex-shrink-0 self-start w-[120px]">
                <UAvatar
    ...
    <div v-else class="m-auto mt-6 fixed inset-0 flex items-center justify-center">
<div role="status">
